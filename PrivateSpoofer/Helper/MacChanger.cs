...
namespace PrivateSpoofer.Helper
{
    public class MacChanger
    {
        ...
        public MacChanger(ManagementObject a, string aname, string cname, int n)
        {
            this.adapter = a;
        ...
        public MacChanger(NetworkInterface i) : this(i.Description) { }

        public MacChanger(string aname)
        {
            this.adaptername = aname;
        ...
        public bool SetRegistryMac(string value)
        {
            ...
            try
            {
                ...
                if (value.Length > 0 && !MacChanger.IsValidMac(value, false))
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Authorization Error Mac Address ( NOT IMPORTEND! )");
        ...
        {
            return IsValidMac(MacChanger.MacToString(bytes), actual);
        }
